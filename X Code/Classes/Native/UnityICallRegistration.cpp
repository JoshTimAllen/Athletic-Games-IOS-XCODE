void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.Analytics.AnalyticsSessionInfo
		...
		void Register_UnityEngine_Analytics_AnalyticsSessionInfo_get_sessionCount();
		Register_UnityEngine_Analytics_AnalyticsSessionInfo_get_sessionCount();
	...
	//Start Registrations for type : UnityEngine.iOS.Device
		...
		//System.Boolean UnityEngine.iOS.Device::IsAdTrackingEnabled()
		void Register_UnityEngine_iOS_Device_IsAdTrackingEnabled();
		Register_UnityEngine_iOS_Device_IsAdTrackingEnabled();

		//System.String UnityEngine.iOS.Device::GetAdIdentifier()
		void Register_UnityEngine_iOS_Device_GetAdIdentifier();
		Register_UnityEngine_iOS_Device_GetAdIdentifier();
